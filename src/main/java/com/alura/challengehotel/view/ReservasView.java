...
public class ReservasView extends JFrame {
    ...
    public ReservasView() {
        ...
        txtFechaSalida.addPropertyChangeListener(new PropertyChangeListener() {
            public void propertyChange(PropertyChangeEvent evt) {
                ...
                txtValor.setText(String.valueOf(calculateValue()));
            }
        });
        ...
        btnNext.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                var dateCheckIn = txtFechaEntrada.getDate();
                var dateCheckOut = txtFechaSalida.getDate();
    ...
    private float calculateValue(){
        ...
        if (txtFechaEntrada.getDate() != null && txtFechaSalida.getDate() != null) {
            long differenceMillis = txtFechaSalida.getDate().getTime() - txtFechaEntrada.getDate().getTime();
